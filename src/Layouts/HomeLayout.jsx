            ...
            <div >
                ...
                <div className="drawer-content">
                  ...
                  {/* <div className="drawer-side w-0"> 
                    ...
                    <ul className="flex align-center justify-around text-white text-1xl font-semibold" >
...
{/* 
                        ...
                        <li className="flex align-center gap-7">
